...
```
From the above response, the **Extraction ID** in the **Notes** field is 2000000002049332. To get the file description including the size of file, the following HTTP GET request is used.
